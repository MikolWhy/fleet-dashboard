...
def get_fleet_data():
    ...
    # Each key becomes a column, each list becomes a row
    # eg: fleet_id is a COLUMN, and its items are each on its ROWs
    data = {
...
def home():
    ...
    return jsonify({
        ...
        # if API not running, would return connection error in the 5XX range
    })
...
def get_all_fleet_data():
    ...
    """
    #get our pandas DataFrame, using our helper function at the top of the file
    df = get_fleet_data()
